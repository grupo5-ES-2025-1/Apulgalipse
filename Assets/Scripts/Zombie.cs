...
public class Zombie : Enemy
{
    ...
    private bool isTouchingPlayer = false; // Flag de contato
    ...
    private void Update()
    {
        ...
        else if (isChasing && dist >= stopChaseRange) isChasing = false;
    ...
    private void Attack()
    {
        ...
        Debug.Log($"Zombie atacou, encontrou {hits.Length} colliders.");
